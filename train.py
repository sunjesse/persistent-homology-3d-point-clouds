...
for epoch in range(args.epochs):
    ...
    # print progress
    src_print_losses = {k: v * 1.0 / src_count for (k, v) in src_print_losses.items()} # len(src_train_loader) = src_count
    ...
    test_acc, test_loss, test_conf_mat = test(src_test_loader, model, "Source", "Test", epoch)
    ...
    if test_acc > src_best_val_acc:
        src_best_val_acc = test_acc
        src_best_val_loss = test_loss
