...
python ../train.py --epochs 250 --emb_dims 1024 --out_path ../experiments --dataroot ../data --src_dataset modelnet40 --apply_PCM False --cls_weight 1.0 --DefRec_weight 0.2 --lr 1e-3 --wd 5e-5 --exp_name mn40_1207_sup --optimizer ADAM 
